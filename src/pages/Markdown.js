...
export default () => {
	return (
		<div>
			...
			<h2>
				<a id="user-content-available-scripts" class="anchor" href="#available-scripts" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>Available Scripts</h2>
			<p>In the project directory, you can run:</p>
			<h3>
				<a id="user-content-npm-start" class="anchor" href="#npm-start" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a><code>npm start</code>
			</h3>
			...
			<h3>
				<a id="user-content-npm-test" class="anchor" href="#npm-test" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a><code>npm test</code>
			</h3>
			...
			<h3>
				<a id="user-content-npm-run-build" class="anchor" href="#npm-run-build" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a><code>npm run build</code>
			</h3>
			...
			<h3>
				<a id="user-content-npm-run-eject" class="anchor" href="#npm-run-eject" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a><code>npm run eject</code>
			</h3>
		...
		<h3>
			<a id="user-content-code-splitting" class="anchor" href="#code-splitting" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>Code Splitting</h3>
		...
		<h3>
			<a id="user-content-analyzing-the-bundle-size" class="anchor" href="#analyzing-the-bundle-size" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>Analyzing the Bundle Size</h3>
		...
		<h3>
			<a id="user-content-making-a-progressive-web-app" class="anchor" href="#making-a-progressive-web-app" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>Making a Progressive Web App</h3>
		...
		<h3>
			<a id="user-content-advanced-configuration" class="anchor" href="#advanced-configuration" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>Advanced Configuration</h3>
		...
		<h3>
			<a id="user-content-deployment" class="anchor" href="#deployment" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>Deployment</h3>
		...
		<h3>
			<a id="user-content-npm-run-build-fails-to-minify" class="anchor" href="#npm-run-build-fails-to-minify" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a><code>npm run build</code> fails to minify</h3>
